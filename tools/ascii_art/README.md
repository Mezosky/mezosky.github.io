...
| `_data/ascii/medusa_field.yml` | about, wide        | Gericault, _The Raft of the Medusa_ |
...
a reader without JavaScript sees. No page uses that at the moment. The portrait field is chosen once for the whole site with
